...
// Changes vs upstream:
//   - System.currentTimeMillis() replaced with change.uptimeMillis (PointerInputChange field; CMP-compatible)
    ...
    detectCustomDragGestures(
        ...
        onDrag = { change, _ ->
            config?.apply {
                ...
                // CMP fix: use change.uptimeMillis instead of System.currentTimeMillis() (JVM-only)
