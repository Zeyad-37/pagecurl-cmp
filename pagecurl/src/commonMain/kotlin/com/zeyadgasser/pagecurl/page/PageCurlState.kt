...
import com.zeyadgasser.pagecurl.config.rememberPageCurlConfig
 ...
 *
 * @param initialCurrent The initial current page.
 * @param config The configuration for PageCurl (deprecated — pass config to PageCurl composable instead).
 * @return The remembered [PageCurlState].
 */
@ExperimentalPageCurlApi
@Composable
 ...
 * @param initialCurrent The initial current page.
 * @param config The configuration for PageCurl (deprecated).
 * @return The remembered [PageCurlState].
 */
@ExperimentalPageCurlApi
@Composable
...
public class PageCurlState(
     ...
     * When going forward it changes from 0 to 1, when going backward it goes from 0 to -1.
     */
